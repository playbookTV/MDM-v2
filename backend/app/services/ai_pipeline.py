        ...
        try:
            ...
            if result.get("status") == "success":
                ...
                return {
                    ...
                    'scene_type': runpod_output.get('scene_analysis', {}).get('scene_type', 'unknown'),
                    'scene_conf': runpod_output.get('scene_analysis', {}).get('confidence', 0.0),
                    'objects_detected': len(runpod_output.get('objects', [])),
                    'primary_style': 'contemporary',  # Default, RunPod handler needs style analysis
                    'style_confidence': 0.0,
                    'depth_available': runpod_output.get('depth_map') is not None,
